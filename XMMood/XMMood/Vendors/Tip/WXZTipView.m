...
- (id)initWithText:(NSString *)text {
    if (self = [super init]) {
        ...
        UILabel *textLabel = [[UILabel alloc] initWithFrame:CGRectMake(15.0f, 10.0f, rect.size.width, rect.size.height )];
        ...
        _contentView = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, textLabel.frame.size.width + 30.0f, textLabel.frame.size.height + 20.0f)];
